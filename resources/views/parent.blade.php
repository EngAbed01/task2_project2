...
<head>
  ...
  <link href="{{ asset('file/css/clean-blog.min.css') }}" rel="stylesheet">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="{{ route('app.home') }}">Start Bootstrap</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('app.post') }}">Sample Post</a>
          </li>
          <li class="nav-item">
  ...
  <script src="{{ asset('file/js/clean-blog.min.js') }}"></script>
  @yield('scripts')
